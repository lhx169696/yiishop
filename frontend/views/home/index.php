...
<head>
	...
	<link rel="stylesheet" href="/statics/style/index.css" type="text/css">
	<link rel="stylesheet" href="/statics/style/bottomnav.css" type="text/css">
...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京西！[<a href="<?=\yii\helpers\Url::to(['user/login'])?>"><?=  \Yii::$app->user->isGuest?"登录":\Yii::$app->session->get("username")?></a>] [<a href="<?=\yii\helpers\Url::to(['user/regist'])?>">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="index.html"><img src="/statics/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
				<div class="search_form">
					<div class="form_left fl"></div>
                    <form action="<?= \yii\helpers\Url::to(['goods/search'])?>" name="serarch" method="post" class="fl">
			...
			<div class="user fl">
				<dl>
					...
					<dd>
						<div class="prompt">
							您好，请<a href="<?=\yii\helpers\Url::to(['user/login'])?>"><?=  \Yii::$app->user->isGuest?"登录":\Yii::$app->session->get("username")?></a>
						</div>
						<div class="uclist mt10">
							<ul class="list1 fl">
								<li><a href="">用户信息></a></li>
								<li><a href="<?=\yii\helpers\Url::to(['goods/confirmorder'])?>">我的订单></a></li>
								<li><a href="">收货地址></a></li>
								<li><a href="">我的收藏></a></li>
							</ul>
							...
							<ul class="fl">
								...
								<li><a href="">我的红包></a></li>
								<li><a href="">我的评论></a></li>
								<li><a href="<?= \yii\helpers\Url::to(['user/loginout'])?>">退出登陆></a></li>
							</ul>
						...
						<div class="viewlist mt10">
							<h3>最近浏览的商品：</h3>
							<ul>
								<li><a href=""><img src="/statics/images/view_list1.jpg" alt="" /></a></li>
								<li><a href=""><img src="/statics/images/view_list2.jpg" alt="" /></a></li>
								<li><a href=""><img src="/statics/images/view_list3.jpg" alt="" /></a></li>
							</ul>
						</div>
					</dd>
				</dl>
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
                    <?php foreach ($categorys as $rows =>$value):?>
                        <?php
                        if ($value['level']==1):
                            ?>
					<div class="cat item1">
						<h3><a href="<?= \yii\helpers\Url::to(['goods/list','catid'=>$value['id']])?>">
                                 <?= $value['name']?>
                            </a> <b></b></h3>
                        <div class="cat_detail">
                        <?php foreach ($categorys as $cc=> $res):?>

                            <?php if($res['pid']==$value['id']):?>

							<dl class="dl_1st">
								<dt><a href="<?= \yii\helpers\Url::to(['goods/list','catid'=>$res['id']])?>">
                                                     <?= $res['name']?>
                                    </a></dt>
								<dd>
                                    <?php foreach ($categorys as $love=>$wan):?>

                                        <?php if($res['id']==$wan['pid']):?>
									<a href="<?= \yii\helpers\Url::to(['goods/list','catid'=>$wan['id']])?>"><?= $wan['name']?></a>
                                        <?php endif;?>
                                    <?php endforeach;?>
								</dd>
							</dl>
	...
	<div class="colligate w1210 bc mt10">
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items">
					<ul>
						<li><a href=""><img src="/statics/images/index_slide1.jpg" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/index_slide2.jpg" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/index_slide3.jpg" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/index_slide4.jpg" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/index_slide5.jpg" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/index_slide6.jpg" alt="" /></a></li>
					</ul>
				</div>
		...
		<div class="coll_right fl ml10">
			<div class="ad"><a href=""><img src="/statics/images/ad.jpg" alt="" /></a></div>
			...
			<div class="service mt10">
				...
				<div class="service_wrap">
					...
					<div class="travel none">
						<ul>
							<li>
								<a href=""><img src="/statics/images/holiday.jpg" alt="" /></a>
								<a href="" class="button">度假查询</a>
							</li>
							<li>
								<a href=""><img src="/statics/images/scenic.jpg" alt="" /></a>
					...
					<div class="lottery none">
						<p><img src="/statics/images/lottery.jpg" alt="" /></p>
					</div>
					<!-- 彩票 end -->
					...
					<div class="game none">
						<ul>
							<li><a href=""><img src="/statics/images/sanguo.jpg" alt="" /></a></li>
							<li><a href=""><img src="/statics/images/taohua.jpg" alt="" /></a></li>
							<li><a href=""><img src="/statics/images/wulin.jpg" alt="" /></a></li>
						</ul>
					</div>
					<!-- 游戏 end -->
				</div>
	...
	<div class="guide w1210 bc mt15">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/crazy1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/crazy2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/crazy3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/crazy4.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/crazy5.jpg" alt="" /></a></dt>
				...
				<div class="hot none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/hot2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/hot3.jpg" alt="" /></a></dt>
				...
				<div class="recommend none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/recommend1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/recommend2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/recommend3.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href=""><img src="/statics/images/viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href=""><img src="/statics/images/samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					...
					<p><a href=""><img src="/statics/images/notebook.jpg" alt="" /></a></p>
				</div>
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
							<li>
								<dl>
									<dt><a href=""><img src="/statics/images/hpG4.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/statics/images/thinkpad e420.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/statics/images/acer4739.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/statics/images/samsung6800.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/statics/images/lh531.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/statics/images/qinghuax2.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<li><a href=""><img src="/statics/images/dell.gif" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/acer.gif" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/fujitsu.jpg" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/hp.jpg" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/lenove.jpg" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/samsung.gif" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/dlink.gif" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/seagate.jpg" alt="" /></a></li>
						<li><a href=""><img src="/statics/images/intel.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
			<!-- 品牌旗舰店 end -->
			...
			<!-- 广告 start -->
			<div class="ads mt10">
				<a href=""><img src="/statics/images/canon.jpg" alt="" /></a>
			</div>
			<!-- 广告 end -->
		</div>
		<!-- 右侧 end -->
