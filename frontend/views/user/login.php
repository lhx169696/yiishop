	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="<?=\yii\helpers\Url::to(['user/loginto'])?>" method="post">
					<ul>
						<li>
						...
						<li>
							...
							<a href="<?=\yii\helpers\Url::to(['user/findpwd'])?>">忘记密码?</a>
						</li>
						<li class="checkcode">
							<label for="">验证码：</label>
							<input type="text"  name="code" />
							<img  id="code" src="<?=\yii\helpers\Url::to(['user/code'])?>" alt="" />
							<span>看不清？<a href="javascript:void (0)" id="get_code" >换一张</a></span>
						</li>
						<li>
							<label for="">&nbsp;</label>
			...
			<div class="guide fl">
				...
				<a href="<?=\yii\helpers\Url::to(['user/regist'])?>" class="reg_btn">免费注册 >></a>
			</div>
...
<script type="text/javascript">
    $(function () {
        $("#get_code").click(function () {
            $.getJSON('<?=\yii\helpers\Url::to(['user/code'])?>',{refresh:1},function (date) {
