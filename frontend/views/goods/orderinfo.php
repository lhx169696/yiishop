...
<head>
	...
	<link rel="stylesheet" href="/statics/style/fillin.css" type="text/css">
	<link rel="stylesheet" href="/statics/style/footer.css" type="text/css">

	<script type="text/javascript" src="/statics/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="/statics/js/cart2.js"></script>
...
<body>
	...
	<div class="fillin w990 bc mt15">
			...
			<div class="goods">
				...
				<table>
                    ...
                    <?php   foreach($cart as $v):?>
						<tr>
							<td class="col1"><a href=""><img src="<?= isset($v->goods->goodsimages[0])?$v->goods->goodsimages[0]->url:""?>" alt="" /></a>  <strong><a href=""><?= $v->goods->name?></a></strong></td>
							<td class="col3"><?= $v->goods->price?></td>
							<td class="col4"> <?= $v->goods_num?></td>
							<td class="col5"><span><?= $v->goods->price * $v->goods->goods_num?></span></td>
                            <?php $count+=$v->goods_num;
                            $num+=$v->goods->price * $v->goods_num;
                            ?>
                        </tr>
                    <?php  endforeach;?>
					</tbody>
		...
		<div class="fillin_ft">
			<a href="<?=\yii\helpers\Url::to(['goods/confirmorder'])?>"><span>提交订单</span></a>
