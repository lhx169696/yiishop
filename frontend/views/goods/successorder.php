...
<head>
	...
	<link rel="stylesheet" href="/statics/style/success.css" type="text/css">
...
<body>
	...
	<div class="success w990 bc mt15">
		...
		<div class="success_bd">
            <div id="qushow" style="text-align: center">
                <img src="<?=$wxurl ?>" id="wxurl" alt=""/>
            </div>
...
<script type="text/javascript">
    $(function () {
        setInterval(function () {
          $.get('<?= \yii\helpers\Url::to(['checkout/qrorder'])?>',{
          'order_no':'<?= $order_no?>'},function (date) {

                       if(date.status){
                           $("#qushow").empty();
                           $("#qushow").append('<img src="/statics/images/wx.jpg"  alt=""/>');
                       }
          },'json')
