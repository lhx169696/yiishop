...
<head>
	...
	<link rel="stylesheet" href="/statics/style/goods.css" type="text/css">
	<link rel="stylesheet" href="/statics/style/common.css" type="text/css">
	...
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="/statics/style/jqzoom.css" type="text/css">

	<script type="text/javascript" src="/statics/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="/statics/js/header.js"></script>
	<script type="text/javascript" src="/statics/js/goods.js"></script>
	<script type="text/javascript" src="/statics/js/jqzoom-core.js"></script>
...
<body>
	...
	<div class="main w1210 mt10 bc">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/statics/images/relate_view5.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?=$GoodsOne->name?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$GoodsOne->goodsimages[0]->url?>_557px" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$GoodsOne->goodsimages[0]->url?>_350px" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                      <?php foreach ($GoodsOne->goodsimages as $res=>$v):?>
								<li  <?=($res==0)? "class=\"cur\"":""?>>
									<a <?=($res==0)? "class=\"zoomThumbActive\"":""?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?= $v->url?>_350px',largeimage: '<?= $v->url?>_557px'}"><img src="<?= $v->url?>_50px"></a>
								</li>
                                  <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?=$GoodsOne->goods_on?></li>
						<li class="market_price"><span>定价：</span><em>￥<?=$GoodsOne->price+100?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?=$GoodsOne->price?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?= date("Y-m-d",$GoodsOne->create_time)?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="<?= \yii\helpers\Url::to(['goods/addcart'])?>" method="get" class="choose">
							...
							<li>
								<dl>
									...
									<dd>
                                        ...
                                        <input type="hidden" name="goods_id" value="<?= $GoodsOne->id?>"/>
				...
				<div class="detail_bd">
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/statics/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/statics/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/statics/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
...
<?php
    $fileContent=ob_get_contents();
      file_put_contents("goodsdetail/goods_".$GoodsOne->id.".html",$fileContent);
?>