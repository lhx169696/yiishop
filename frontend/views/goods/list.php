...
<head>
	...
	<link rel="stylesheet" href="/statics/style/list.css" type="text/css">
				...
				<div class="cat_bd none">
					...
					<div class="cat item1">
						...
						<div class="cat_detail none">
							...
							<dl class="dl_1st">
								<dt><a href="<?= \yii\helpers\Url::to(['goods/list','catid'=>$res['id']])?>"><?= $res['name']?></a></dt>
								<dd>
	...
	<div class="list w1210 bc mt10">
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/statics/images/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/statics/images/list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
                    <?php foreach ($Goods as $res):?>
					<li>
						<dl>
							<dt><a href="<?= \yii\helpers\Url::to(['goods/detail','id'=>$res->id])?>">


                                    <img src="<?=isset($res->goodsimages[0])? $res->goodsimages[0]->url:''?>" alt="" />


                                </a></dt>
							<dd>
                                <a href="<?= \yii\helpers\Url::to(['goods/detail','id'=>$res->id])?>"><?= $res->name?></a>
                            </dt>
							<dd><strong><?= $res->price?></strong></dt>
