...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="/statics/images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
        ...
        <div id="send_info">
            ...
            <a href="<?= \yii\helpers\Url::to(['user/loginout'])?>" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
    <ul>
        ...
        <li><a href="<?= \yii\helpers\Url::to(['brand/list'])?>" target="main-frame">起始页</a></li>
        <li><a href="<?= \yii\helpers\Url::to(['brand/list'])?>" target="main-frame">品牌列表</a></li>
        <li><a href="<?= \yii\helpers\Url::to(['goods/list'])?>" target="main-frame">商品列表</a></li>
        <li><a href="<?= \yii\helpers\Url::to(['category/list'])?>" target="main-frame">分类管理列表</a></li>
        <li><a href="<?= \yii\helpers\Url::to(['user/list'])?>" target="main-frame">会员列表</a></li>
