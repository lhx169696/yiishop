...
.explode {
  background:url(/statics/images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/statics/images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/statics/images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/statics/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            <li class="explode" key="03_cat_and_goods" name="menu">
                商品管理
                <ul>
                    <li class="menu-item"><a href="<?= \yii\helpers\Url::to(['brand/list'])?>" target="main-frame">品牌列表</a></li>
                    <li class="menu-item"><a href="<?= \yii\helpers\Url::to(['brand/add'])?>" target="main-frame">添加品牌</a></li>

                </ul>
            </li>
            <li class="explode" key="03_cat_and_category" name="menu">
                商品分类管理
                <ul>
                    <li class="menu-item"><a href="<?= \yii\helpers\Url::to(['category/list'])?>" target="main-frame">分类列表</a></li>
                    <li class="menu-item"><a href="<?= \yii\helpers\Url::to(['category/add'])?>" target="main-frame">添加分类</a></li>
            ...
            商品管理
                <ul>
                    <li class="menu-item"><a href="<?=\yii\helpers\Url::to(['goods/list'])?>" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="<?=\yii\helpers\Url::to(['goods/add'])?>" target="main-frame">添加新商品</a></li>

                </ul>
            </li>
            <li class="explode" key="02_cat_and_permission" name="menu">
                权限管理
                <ul>
                    <li class="menu-item"><a href="<?=\yii\helpers\Url::to(['permission/list'])?>" target="main-frame">权限列表</a></li>
                    <li class="menu-item"><a href="<?=\yii\helpers\Url::to(['permission/add'])?>" target="main-frame">添加权限</a></li>

                </ul>
            </li>


            <li class="explode" key="02_cat_and_role" name="menu">
                角色管理
                <ul>
                    <li class="menu-item"><a href="<?=\yii\helpers\Url::to(['role/list'])?>" target="main-frame">角色列表</a></li>
                    <li class="menu-item"><a href="<?=\yii\helpers\Url::to(['role/add'])?>" target="main-frame">角色权限</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_user" name="menu">
                用户管理
                <ul>
                    <li class="menu-item"><a href="<?=\yii\helpers\Url::to(['user/list'])?>" target="main-frame">用户列表</a></li>
                    <li class="menu-item"><a href="<?=\yii\helpers\Url::to(['user/add'])?>" target="main-frame">用户权限</a></li>
...
<script type="text/javascript" src="/statics/js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/statics/images/menu_minus.gif' : '/statics/images/menu_plus.gif';
