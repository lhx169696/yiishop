...
<div class="main-div">
    <form action="<?= \yii\helpers\Url::to(['user/create'])?>" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type='text' name='User[username]' maxlength="20" value='' size='27' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">密码:</td>
                <td>
                     <input type="password" name="User[password_hash]" maxlength="20" value='' size='27' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label">邮箱:</td><td>
                    <input type="text" name="User[email]" maxlength="20" value='' size='27' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">用户状态:</td>
                    <td>
                    <input type="radio" name="User[status]" value="1" maxlength="20" size='27' /> <font color="red">*</font>开启
                    <input type="radio" name="User[status]" value="0" maxlength="20"  size='27' /> <font color="red">*</font>禁用
                </td>
            </tr>
            <tr>
                ...
                <td>
                   ...
                   <input type="checkbox" name="role[]" value="<?= $v->name?>"/> <?= $v->description?>
                    <?php endforeach;?>
                </td>
            </tr>
