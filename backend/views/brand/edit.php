...
<div class="main-div">
    <?php
    $from=\yii\widgets\ActiveForm::begin(['action'=>\yii\helpers\Url::to(['brand/update','id'=>$model->id])]);
    ?>
       <table width="100%" id="general-table">
            ...
            <tr>
                ...
                <td>
                    <div id="upload-handle" >点击上传</div>
                    <input type="file" id="file_upload" style="display: none;"/>
                    <img src="<?= $model->logo?>" id="show_logo" width="50"/>
