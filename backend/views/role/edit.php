...
<div class="main-div">
    <form action="<?= \yii\helpers\Url::to(['role/updeta'])?>" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            ...
            <tr>
                ...
                <td>
                    <input type='hidden' name='nameto' maxlength="20" value='<?= $modelone->name?>' size='27' /> <font color="red">*</font>
                    <input type='text' name='name' maxlength="20" value='<?= $modelone->name?>' size='27' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <?php foreach ($model as $v):?>
                            ...
                            <input type="checkbox" name="permission[]"  value="<?= $v->name?>" <?php foreach ($chlie as $r) echo $r->child==$v->name?'checked':"" ?>  /> <?= $v->description?>
            ...
            <tr>
                ...
                <td>
                    <textarea rows="7" cols="30"  name="description"><?= $modelone->description?></textarea>
                </td>
            </tr>
        </table>
